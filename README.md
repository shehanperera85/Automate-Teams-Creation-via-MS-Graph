...
# Order of files
### [Intro and Prereqs](https://github.com/shehanperera85/Teams-via-MS-Graph-and-Power-Automate/blob/main/IntroAndPrereqs.md#create-teams-via-microsoft-graph)
### [Solution](https://github.com/shehanperera85/Teams-via-MS-Graph-and-Power-Automate/blob/main/Solution.md#how-to-create-the-power-automate-flow)
